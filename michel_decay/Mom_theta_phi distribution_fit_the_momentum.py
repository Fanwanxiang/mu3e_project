...
for i in sample_size_l:
    P_max,Err_P_max, N_mon_accept, Err_N_mon_accept, N_ratio_accept, Err_ratio_accept = cal_Pmaxbar_for_sampleNO(Nsample = i, Nsim=10)
...
N_ratio_accept, Err_ratio_accept = fit_P_max(x,y0,noise,func,'sample size','ratio','Fitted P_max at various sample size')
