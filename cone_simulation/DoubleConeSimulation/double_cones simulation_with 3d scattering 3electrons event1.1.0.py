...
R =10**9 # particles per unit time -- unit: 1/s
dt = 10**(-9)  # s  i.e. 1ns #time resolution in second
dx = 100*10**(-1) #space resolution in meter
dy = 2*50*10**(-1)
dz = 2*50*10**(-1)
...
def plot_3e(N1, lmax, theta, title): # and return 3electtron events and the original events
    ...
    return x_3e, y_3e, z_3e, l_3e, phi_3e, x, y, z, l, phi
'''
...
x_3e, y_3e, z_3e, l_3e, phi_3e, x, y, z, l, phi = plot_3e(N1 = N_half, lmax = ls, theta = angle, title = 'indistinguishable 3e decays')
